...
<body>
    ...
    <div class="temp">
    	<div class="bigtitle">申请加分项</div>
    	<div class="mainboby box-body">
			<table id="rowed3"></table>
			<div id="prowed3"></div>
		</div>
		<div class="addtitle">申请添加</div>
        <div>
        <form>
                <div class="Name">
                    <div class="name fl"><span>分数：</span></div>
                    <div><input type="text" class="prizeName"></div>
                </div>
                <div class="Need">
                    <div class="need fl"><span>分数类型：</span></div>
                    <div>
                    	<select class="prizeNeed">
  							<option value ="300001">日常行为分</option>
  							<option value ="300002">科技竞赛个性发展分</option>
  							<option value ="300003">体能分</option>
  							<option value ="300004">学生工作个性发展分</option>
  							<option value ="300005">社会实践能力个性发展分</option>
  							<option value ="300006">辅修及计算机水平个性发展分</option>
  							<option value ="300007">特殊表彰</option>
						</select>
					</div>
                </div>
                <div class="PDetail">
                    <div class="pDetail fl"><span>分数名：</span></div>
                    <div><input type="text" class="prizeDetail" /></div>
                </div>
                <div class="ADetail">
                    <div class="aDetail fl"><span>添加详情：</span></div>
                    <div><input type="text" class="addDetail" /></div>
                </div>
...
<script type="text/javascript" src="../js/addScoreItem.js"></script>
</html>