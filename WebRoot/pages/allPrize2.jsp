...
<head>
    ...
    <link href="../pages/css/allPrize.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div id="main-info">
        ...
        <div id="main-table">
            <p id="see-rank"><span>所有奖项</span></p>
            <table id="see-rank-table">
            </table>
            <input id="apply" type="button" value="申请奖项" onclick="applyPrize()"/>
            <div id="appealMyPrize">
                <p id="systemTitle">申请原因</p>
                <p id="tip">请在下方输入申请原因：<p>
...
<script type="text/javascript" src="../js/allPrize.js">
</script>
</html>