                            ...
                            <div class="col-md-12">
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <form:form method="post" action="../winScore/addWinScoreByExcel.do" enctype="multipart/form-data">
...
<!--     <script type="text/javascript" src="js/jQuery-Cookie/jquery.cookie.min.js"></script> -->
    ...
    <!-- <script type="text/javascript" src="js/temp1.js"></script> -->
    <!-- <script>
