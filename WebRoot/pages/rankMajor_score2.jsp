...
<head>
    ...
    <link href="../pages/css/rankMajor_score.css" rel="stylesheet" type="text/css">
...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="../pages/rank2.jsp">查看排名</a>
                                </li>
                                <li>
                                    <a href="../pages/myScore2.jsp">我的成绩</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li> 
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="../pages/myPrize2.jsp">我的获奖</a>
                                </li>
                                <!-- <li>
                                    <a href="../pages/allPrize2.jsp">查看奖项</a>
                                </li> -->
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="../pages/valueEachOther2.jsp">班内互评</a>
                                </li>
                                <li>
                                    <a href="../pages/evaluationResult2.jsp">查看结果</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="../pages/appealPrize2.jsp">申诉获奖</a>
                                </li>
                                <li>
                                    <a href="../pages/appealScore2.jsp">修改加分</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
    ...
    <div id="main-info">
        ...
        <div id="main-table">
            ...
            <p id="class1" onclick="window.location.href='../pages/rank2.jsp'">班级成绩表</p>
            <p id="class2" onclick="window.location.href='../pages/rank_score2.jsp'">班级加分表</p>
            <p id="major1" onclick="window.location.href='../pages/rankMajor2.jsp'">专业成绩表</p>
            <p id="major2" onclick="window.location.href='../pages/rankMajor_score2.jsp'">专业加分表</p>
            <div id="classRank">
...
<script type="text/javascript" src="../js/rankMajor_score.js">
</script>
</html>