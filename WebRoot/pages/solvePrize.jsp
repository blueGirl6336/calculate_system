...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> 查看成绩<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="withdrawverify">查看成绩</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="acounthouse">申请添加</a>
                                </li>
                                <li>
                                    <a href="acountagent">查看状态</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
    ...
    <div class="temp">
    	<div class="bigtitle">处理申请</div>
    	<div class="mainboby box-body">
			<table id="rowed3"></table>
			<div id="prowed3"></div>
		</div>
		<div class="addtitle">审核奖项</div>
        <table id="see-rank-table"></table>
</div>   	
</body>
<script type="text/javascript" src="../js/solvePrize.js">
</script>
</html>