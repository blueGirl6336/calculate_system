                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                       ...
                                       <input type="submit" value="上传"  class="btn btn-default Submit" />
                                        ...
                                        <div class="labelTitle">请输入以下内容手动录入或修改成绩：</div>
                                        <div class="label1">学号：</div>
                                        <input type="text" name="userName" class="userName form-control">
                                        <div class="label2">课程：</div>
                                        <select class="courseId form-control"></select>
                                        <div class="label2">分数：</div>
                                        <input type="text" name="point" class="point form-control">
                                        <button class="enter btn btn-default">录入</button>
                                    </div>
                                <!-- </div> -->
                                <!-- /BOX -->
                            </div>
