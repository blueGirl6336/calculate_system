...
public class StudentDaoImpl extends BaseDaoImpl implements StudentDao {
	...
	@Override
	public List<Student> searchByMajorNameAndGradeNumber(String majorName,
			int gradeNumber) {
		String hql = "from Student as s where s.classes.major.majorName = '"
				+ majorName + "' and s.classes.grade.gradeNumber = "
				+ gradeNumber;
		List<Student> students = (List<Student>) this.getHibernateTemplate()
				.find(hql);
	...
	public List<Student> getStudentByClassAndSortByStudentNumber(
		...
		String hql = "from " + "Student as s"
				+ " where classes.classNumber=? order by " + "s.users.userName";
		String[] param = new String[] { ClassNumber };
		studentList = (List<Student>) this.getHibernateTemplate().find(hql,
				param);
