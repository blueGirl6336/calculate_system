...
<body>
    ...
    <div class="temp">
        ...
        <form>
                <div class="Name">
                    <div class="name fl"><span>奖项名：</span></div>
                    <div><input type="text" class="prizeName"></div>
                </div>
                <div class="Need">
                    <div class="need fl"><span>奖项要求：</span></div>
                    <div><input type="text" class="prizeNeed" /></div>
                </div>
                <div class="PDetail">
                    <div class="pDetail fl"><span>奖项详情：</span></div>
...
<script type="text/javascript" src="../js/addPrizeItem.js"></script>
</html>