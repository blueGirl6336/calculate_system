...
<!-- Bootstrap Core CSS -->
    ...
    <link href="../pages/css/evaluationResult.css" rel="stylesheet" type="text/css">

    <!--jquery-->
    <script src="../js/jquery/jquery-2.0.3.min.js" type="text/javascript"></script>
    <script src="../js/jqgrid/jquery.jqGrid.min.js" type="text/javascript"></script>
    <link rel="stylesheet" type="text/css" href="../pages/css/outGrades.css">
...
<div id="main-info">
        <p id="title1" class="outTitle"><span>导出互评</span></p>
        <div class="SearchClass">
            <span>请输入查询班号：</span>
            <input type="text" name="classNumber" class="classNumber">
            <button type="button" class="btn btn-primary btn-sm searchClass">查询</button> 
            <button type="button" class="btn btn-primary btn-sm outTotal">导出总表</button> 
            <button type="button" class="btn btn-primary btn-sm outAll">导出所有记录</button> 
        </div>
        
        <div id="main-table">
            <p id="see-rank"><span>查看成绩</span></p>
    ...
    <script src="js/outGrades.js"></script>
